...
func main() {
	...
	mux.HandleFunc("POST /v1/merchant/{username}/update-bank", merchantHandler.UpdateBankDetails)
	mux.HandleFunc("POST /v1/merchant/{username}/upload-document", merchantHandler.UploadDocument)
