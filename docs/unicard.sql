...
CREATE TABLE merchants (
    ...
    status ENUM('pending approval', 'approved', 'rejected', 'active', 'suspended', 'deleted') DEFAULT 'pending approval' COMMENT 'Operational state of the merchant ecosystem tenancy',
...
CREATE TABLE transactions (
    ...
    amount DECIMAL(10, 2) NULL COMMENT 'Total Gross fiat amount captured from the card wallet balance tracking column',
    points_earned DECIMAL(10, 2) NULL DEFAULT NULL COMMENT 'Total points earned from the transaction',
    service_fee DECIMAL(10, 2) NULL DEFAULT NULL COMMENT 'Platform revenue slice collected by UniCard ecosystem engine per tap processing action',
