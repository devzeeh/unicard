...
const char* mqtt_topic = "unicard/card/add"; // MQTT topic for card registration
const char* terminal_id = "REGISTRATION_01"; // Unique identifier for this terminal
...
void setup() {
  ...
  SPI.begin();
  rfid.PCD_Init();
  Serial.println("RFID Card Registration Terminal Ready.");
