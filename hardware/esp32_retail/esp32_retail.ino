...
const char* mqtt_topic = "unicard/retail/scan"; // MQTT topic for retail
const char* terminal_id = "RETAIL_01"; // Unique identifier for this terminal
...
void setup() {
  ...
  SPI.begin();
  rfid.PCD_Init();
  Serial.println("RFID Retail Terminal Ready.");
